                                    ...
                                    <c:forEach items="${bookList}" var="book" varStatus="loop">
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><img
                                                    src="${pageContext.request.contextPath}/Resources/img/products/${book.getImage()}" width="35"
                                                    height="50">
                                    <figcaption>
                                        <a href="${pageContext.request.contextPath}/Resources/img/products/${book.getImage()}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="${pageContext.request.contextPath}/DeleteAllBooks"
                                                    method="POST">
                                                    <button type="submit" class="btn btn-danger">Xóa</button>
                                                </form>
